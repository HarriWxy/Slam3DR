...
class Multiview3D(nn.Module, PyTorchModelHubMixin):
    ...
    def __init__(self,
                 ...
                 in_chans=3,             # input channel count
        ...
        self._set_patch_embed(patch_embed_cls, img_size, patch_size, enc_embed_dim, in_chans=in_chans)
    ...
    def _set_patch_embed(self, patch_embed_cls, img_size=224, patch_size=16, 
                         enc_embed_dim=768, in_chans=3):
        self.patch_size = patch_size
        self.patch_embed = get_patch_embed(patch_embed_cls, img_size, 
                                           patch_size, enc_embed_dim, in_chans=in_chans)
