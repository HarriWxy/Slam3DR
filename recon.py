...
input_group.add_argument("--dataset", default="../Replica/room_0", type=str, help="a string indicating the dataset")
...
parser.add_argument("--test_name", type=str, default="Replica", help="name of the test") # required=True
