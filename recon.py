from slam3dr.pipeline.recon_online_pipeline import scene_recon_pipeline_online, FrameReader
...
parser.add_argument('--save_for_eval', default=True, action='store_true', help='whether to save partial per-frame preds for evaluation')   
