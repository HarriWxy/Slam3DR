...
TEST_DATASET="1000 @ Co3d_Seq(num_views=11, sel_num=3, degree=180, mask_bg='rand', split='test', resolution=224, seed=666) + \
        500 @ ScanNet_Seq(num_views=11,num_seq=50, max_thresh=100, split='val', resolution=224, seed=666)"

# Stage 1: Train the i2p model for pointmap prediction
PRETRAINED="checkpoints/i2p/slam3r_i2p_stage1/checkpoint-last.pth" # "" i2p checkpoints/DUSt3R_ViTLarge_BaseDecoder_224_linear.pth
...
torchrun --nproc_per_node=2 train.py \
    ...
    --lr 5e-5 --min_lr 5e-7 --warmup_epochs 1 --epochs 90 --batch_size 16 --accum_iter 1 \
    --save_freq 2 --keep_freq 20 --eval_freq 1 --print_freq 20 --num_workers 12 \
    --save_config\
    --freeze "encoder"\
    --loss_func 'i2p' \
...
PRETRAINED="checkpoints/i2p/slam3r_i2p_stage1/checkpoint-last.pth"
...
torchrun --nproc_per_node=2 train.py \
    ...
    --pretrained $PRETRAINED \
    --pretrained_type "slam3r" \
    --lr 1e-4 --min_lr 1e-6 --warmup_epochs 1 --epochs 21 --batch_size 16 --accum_iter 1 \
    --save_freq 2 --keep_freq 20 --eval_freq 1 --print_freq 20 --num_workers 12 \
    --save_config\
...
torchrun --nproc_per_node=2 train.py \
    ...
    --pretrained $PRETRAINED \
    --pretrained_type "slam3r" \
    --lr 5e-5 --min_lr 5e-7 --warmup_epochs 2 --epochs 90 --batch_size 16 --accum_iter 1 \
    --save_freq 2 --keep_freq 20 --eval_freq 1 --print_freq 20 --num_workers 12 \
    --save_config\
    --output_dir $TRAIN_OUT_DIR \
    --freeze "encoder"\
