...
TRAIN_DATASET="4000 @ Co3d_Seq(num_views=11, sel_num=3, degree=180, mask_bg='rand', split='train', aug_crop=16, resolution=224, transform=ColorJitter, seed=233) + \
...
#     --lr 5e-5 --min_lr 5e-7 --warmup_epochs 1 --epochs 40 --batch_size 16 --accum_iter 1 \
...
# PRETRAINED="checkpoints/i2p/slam3r_i2p_stage1/checkpoint-best.pth"
...
#     --pretrained $PRETRAINED \
#     --pretrained_type "slam3r" \
#     --lr 1e-4 --min_lr 1e-6 --warmup_epochs 1 --epochs 15 --batch_size 4 --accum_iter 1 \
#     --save_freq 2 --keep_freq 20 --eval_freq 1 --print_freq 20 --num_workers 8 \
#     --save_config\
...
PRETRAINED="checkpoints/slam3r_l2w/checkpoint-best.pth"  #l2w 
